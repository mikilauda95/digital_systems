...
map  i <Plug>SpecialVHDLPasteInstance
map  e <Plug>SpecialVHDLPasteEntity
...
set ruler
set runtimepath=~/.vim,~/.vim/plugged/pyclewn/,~/.vim/plugged/vim-scala/,~/.vim/plugged/vim-test/,~/.vim/plugged/swift.vim/,~/.vim/plugged/ctrlp.vim/,~/.vim/plugged/typescript-vim/,~/.vim/plugged/vim-node/,~/.vim/plugged/syntastic/,~/.vim/plugged/vim-mundo/,~/.vim/plugged/vim-abolish/,~/.vim/plugged/vim-fugitive/,~/.vim/plugged/vim-airline-themes/,~/.vim/plugged/vimwiki/,~/.vim/plugged/vip/,~/.vim/plugged/ultisnips/,~/.vim/plugged/vim-snippets/,~/.vim/plugged/nerdcommenter/,~/.vim/plugged/auto-pairs/,~/.vim/plugged/nerdtree/,~/.vim/plugged/YouCompleteMe/,~/.vim/plugged/vim-flake8/,~/.vim/plugged/vim-nerdtree-tabs/,~/.vim/plugged/python-mode/,~/.vim/plugged/vim-markdown/,~/.vim/plugged/vim-livedown/,~/.vim/plugged/vimtex/,~/.vim/plugged/Zenburn/,~/.vim/plugged/vim-surround/,/var/lib/vim/addons,/usr/share/vim/vimfiles,/usr/share/vim/vim80,/usr/share/vim/vimfiles/after,/var/lib/vim/addons/after,~/.vim/plugged/vim-scala/after,~/.vim/plugged/ultisnips/after,~/.vim/plugged/python-mode/after,~/.vim/plugged/vimtex/after,~/.vim/after
set shiftwidth=4
...
silent only
cd ~/ds-2018/sha256/vhdl
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +13 msched.vhd
badd +0 packages/sha256_pack.vhd
argglobal
silent! argdel *
$argadd msched.vhd
edit packages/sha256_pack.vhd
...
exe '2resize ' . ((&lines * 48 + 30) / 61)
exe 'vert 2resize ' . ((&columns * 149 + 90) / 181)
exe '3resize ' . ((&lines * 10 + 30) / 61)
exe 'vert 3resize ' . ((&columns * 149 + 90) / 181)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 51 - ((35 * winheight(0) + 24) / 48)
